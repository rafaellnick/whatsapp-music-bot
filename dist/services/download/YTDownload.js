...
class YTDownload {
    download(videoId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const videoPath = path_1.default.join(config_1.DOWNLOAD_PATH, `${videoId}.audio`);
    ...
    extractMp3FromMp4(videoPath) {
        return __awaiter(this, void 0, void 0, function* () {
            const outputPath = path_1.default.join(path_1.default.dirname(videoPath), `${path_1.default.parse(videoPath).name}.mp3`);
